...
> = {
  en: {
    ...
    reviews: "Reviews",
    gallery: "Gallery",
    weeklyCare: "Weekly Signature Care",
    repairRecovery: "Repair and Recovery",
    premiumStandard: "Premium Property Standard",
  ...
  es: {
    ...
    reviews: "Resenas",
    gallery: "Galeria",
    weeklyCare: "Cuidado semanal premium",
    repairRecovery: "Reparacion y recuperacion",
    premiumStandard: "Estandar premium residencial",
