...
export default function NewPropertyModal({
  ...
  return (
    <CustomerDetailFormModal
      modal="new-property"
      kicker={t("admin.customers.detail.properties.modalKicker")}
      title={t("admin.customers.detail.properties.modalTitle")}
      subtitle={t("admin.customers.detail.properties.modalSubtitle")}
    >
