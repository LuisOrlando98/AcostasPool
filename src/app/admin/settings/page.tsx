...
const SETTINGS_TABS: Array<{ id: SettingsTabId; label: string }> = [
  ...
  { id: "email-templates", label: "Email templates configurations" },
...
export default async function SettingsPage({ searchParams }: SettingsPageProps) {
  ...
  const [t, socialLinks, landingConfig, emailTemplates] = await Promise.all([
    getTranslations(),
    getSiteSocialLinks(),
    getSiteLandingConfig(),
    getEmailTemplatesConfig(),
          ...
          <div className="grid gap-6 lg:grid-cols-[18rem_minmax(0,1fr)]">
              ...
              <div className="mt-3 space-y-2">
                {EMAIL_TEMPLATE_IDS.map((templateId) => {
                  ...
                  return (
                    <Link
                      key={templateId}
                      href={`/admin/settings?tab=email-templates&template=${templateId}`}
            ...
            <div className="space-y-6">
              <div className="app-card p-6 shadow-contrast">
                ...
                <p className="mt-2 text-sm text-slate-600">{selectedTemplateMeta.description}</p>
              ...
              <div className="app-card p-6 shadow-contrast">
                ...
                <p className="mt-2 text-sm text-slate-600">
                  Preview uses sample values so you can validate layout and copy before saving.
                </p>
